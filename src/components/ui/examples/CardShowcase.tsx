        ...
        <View className="mb-8">
          ...
          <View className="gap-6">
            <EventCard
              ...
              onPress={() => handlePress('Scarpetta 100')}
            />
            ...
            <EventCard
              ...
              onPress={() => handlePress('Abitatori del tempo')}
            />
            ...
            <EventCard
              ...
              onPress={() => handlePress('Riapre al pubblico')}
            />
          </View>
        </View>
        ...
        <View className="mb-8">
          ...
          <View className="gap-6">
            <ExperienceCard
              ...
              onPress={() => handlePress('Duomo di Napoli')}
            />
            ...
            <ExperienceCard
              ...
              onPress={() => handlePress('Altorilievo')}
            />
            ...
            <ExperienceCard
              ...
              onPress={() => handlePress('Abitazione arcaica')}
            />
          </View>
        </View>
        ...
        <View className="mb-8">
          ...
          <View className="gap-6">
            <HeritageCard
              ...
              onPress={() => handlePress('Presepe napoletano')}
            />
            ...
            <HeritageCard
              ...
              onPress={() => handlePress('Pizzaioli napoletani')}
            />
            ...
            <HeritageCard
              ...
              onPress={() => handlePress('Canto tradizionale')}
            />
          </View>
        </View>
        ...
        <View className="mb-8">
          ...
          <View className="gap-4">
            <EventCard
              ...
              onPress={() => handlePress('Minimal Event')}
            />

            <ExperienceCard
              title="Minimal Experience"
              onPress={() => handlePress('Minimal Experience')}
            />

            <HeritageCard
              title="Minimal Heritage"
              onPress={() => handlePress('Minimal Heritage')}
            />
          </View>
        </View>
